package test.java.com.ifood.crawler.unit.adapter.output;
...
class SqlitePersistenceIntegrationTest {
    ...
    void setUp() throws Exception {
        ...
        // Override com reflexão ou criar um mock. Para simplicidade, usamos caminho direto.
        // Em produção, criaríamos um teste com mock de AppConfig.
        // Aqui, vamos criar uma instância manual.
        persistence = new SqlitePersistence(config);
        // Nota: em um teste real, precisaríamos de um AppConfig mockado.
        // Este é um esboço da estrutura.
    }
